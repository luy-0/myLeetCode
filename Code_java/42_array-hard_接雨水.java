...
class Solution {
    public int trap(int[] height) {
        ...
        // 用于打印的两个数组,以便纠错
        /*
         * for (int i = 0; i < leftMaxVol.length; i++) { System.out.printf("%d,",
         * leftMaxVol[i]); } System.out.println();
         * 
         * for (int i = 0; i < rightMaxVol.length; i++) { System.out.printf("%d,",
         * rightMaxVol[i]); } System.out.println();
         */
